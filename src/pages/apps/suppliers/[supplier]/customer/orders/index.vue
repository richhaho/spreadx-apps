      ...
      >
        ...
        <VCard v-for="order in orders" class=" mt-2 ml-2 mr-2 border">
          ...
          <div class="d-flex justify-end mt-1 ml-2 mr-3 mb-3">
            ...
            <VBtn v-if="order.status=='COMPLETED'" color="info" size="small" class="ml-1" @click="downloadInvoice(order)" :to="`/apps/suppliers/${supplier_id}/customer/orders/${order.reference_no}/invoice`">Invoice</VBtn>

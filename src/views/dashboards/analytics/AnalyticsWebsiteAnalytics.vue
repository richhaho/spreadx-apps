<script setup>
import { default as sliderBar1, default as sliderBar2, default as sliderBar3 } from '@images/logo.svg';
...
<template>
  <VCard color="primary">
    <VCarousel cycle
      ...
      <VCarouselItem v-for="item in websiteAnalytics"
        :key="item.name">
        <VCardText>
          <VRow>
            <VCol cols="12">
